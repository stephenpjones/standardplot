...
class PlotConfig:
    ...
    def __init__(self, config_path=None):
        ...
        self.base_config = {
            ...
            'font': {
                'family': 'Bitstream Vera Sans Mono',  # Using your installed font
    ...
    def apply_global_style(self):
        ...
        plt.rcParams.update({
            ...
            'font.family': 'monospace',  # Use monospace family
            'font.monospace': [self.base_config['font']['family']],  # Specify your font
