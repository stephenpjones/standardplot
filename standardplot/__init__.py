...
# Import main components from the correct modules
...
def get_synthesized_palette_info():
    """Get information about the synthesized optimal palette"""
    return plot_config.get_synthesized_palette_info()

def switch_to_legacy_palette():
    """Switch to legacy palette"""
    return plot_config.switch_to_legacy_palette()

def switch_to_synthesized_palette():
    """Switch to synthesized palette"""
    return plot_config.switch_to_synthesized_palette()